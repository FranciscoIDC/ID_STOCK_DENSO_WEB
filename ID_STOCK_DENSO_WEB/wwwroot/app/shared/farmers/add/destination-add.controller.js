(function () {
    angular
        .module('app')
        .controller('DestinationAddController', DestinationAddController);

    DestinationAddController.$inject = [
        '$scope',
        'DestinationAddService',
        'AlertService',
        'DestinationService',
        'ErrorService',
        'RoleListService',
    ...
    function DestinationAddController(self, DestinationAddService, AlertService, DestinationService, ErrorService, RoleListService, GeneralInfo) {
        ...
        function _InitValues() {
            self.model = new DestinationDtoPost();

            self.categories = [];
            self.locations = [];

            self.validations = DestinationService.validations;
        }
        ...
        async function _SaveAsync() {
            try {
                ...
                let response = await DestinationAddService.Save(self.model);
                swal.close();
