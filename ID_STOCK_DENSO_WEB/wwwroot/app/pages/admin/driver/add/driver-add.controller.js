(function () {
    angular
        .module('app')
        .controller('DriverAddController', DriverAddController);

    DriverAddController.$inject = [
        '$scope',
        'DriverAddService',
        'AlertService',
        'DriverService',
    ...
    function DriverAddController(self, DriverAddService, AlertService, DriverService, ErrorService, RoleListService, GeneralInfo) {
        ...
        function _InitValues() {
            ...
            self.validations = DriverService.validations;
        }
        ...
        async function _SaveAsync() {
            try {
                ...
                let response = await DriverAddService.Save(self.model);
                swal.close();
