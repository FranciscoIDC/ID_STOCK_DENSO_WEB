(function () {
    angular
        .module('app')
        .controller('ColdRoomAddController', ColdRoomAddController);

    ColdRoomAddController.$inject = [
        '$scope',
        'ColdRoomAddService',
        'AlertService',
        'ColdRoomService',
    ...
    function ColdRoomAddController(self, ColdRoomAddService, AlertService, ColdRoomService, ErrorService, RoleListService, GeneralInfo) {
        ...
        function _InitValues() {
            ...
            self.validations = ColdRoomService.validations;
        }
        ...
        async function _SaveAsync() {
            try {
                ...
                let response = await ColdRoomAddService.Save(self.model);
                swal.close();
        ...
        function _ClearForm() {
            self.model = new ColdRoomDtoPost();
        }
