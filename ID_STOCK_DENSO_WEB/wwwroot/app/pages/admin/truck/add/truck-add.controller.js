(function () {
    angular
        .module('app')
        .controller('TruckAddController', TruckAddController);

    TruckAddController.$inject = [
        '$scope',
        'TruckAddService',
        'AlertService',
        'TruckService',
    ...
    function TruckAddController(self, TruckAddService, AlertService, TruckService, ErrorService, RoleListService, GeneralInfo) {
        ...
        function _InitValues() {
            ...
            self.validations = TruckService.validations;
        }
        ...
        async function _SaveAsync() {
            try {
                ...
                let response = await TruckAddService.Save(self.model);
                swal.close();
