(function () {
    angular
        .module('app')
        .controller('ColdBoxEditController', ColdBoxEditController);

    ColdBoxEditController.$inject = [
        '$scope',
        '$stateParams',
        'ColdBoxEditService',
        'AlertService',
    ...
    function ColdBoxEditController(self, $stateParams, ColdBoxEditService, AlertService, ErrorService, ConstService, GeneralInfo, RoleListService) {


        async function _Init() {
            _InitValues();
            _RegisterFunctions();
            await _GetColdBoxById();
        }

        function _InitValues() {

            self.editMode = false;
            self.coldBoxId = $stateParams.id;
        ...
        async function _UpdateAsync() {
            try {
                let response = await ColdBoxEditService.Update(self.model);
        ...
        async function _GetColdBoxById() {
            try {
                let response = await ColdBoxEditService.Get(self.coldBoxId);
                const { Status: status, Message: message, Data: data, Counter: counter } = response.data;
                console.log("_GetColdBoxById: ", response);
