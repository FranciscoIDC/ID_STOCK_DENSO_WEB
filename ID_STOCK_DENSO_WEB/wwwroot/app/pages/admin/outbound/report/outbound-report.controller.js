(function () {
    ...
    function OutboundReportController(
        ...
        async function _GetAssetsOnResume() {
            ...
            let params = BuildParamsToGetOutbound(self.currentPage, self.itemsPerPage, self.startDate, self.endDate);
        ...
        async function _Get_toExcel(params) {
            try {
                ...
                request.open("GET", UrlService.getOutboundReport + '/Excel?' + params);
                ...
                request.onload = function () {
                    ...
                    a.download = this.response.name || "Reporte_Salidas" + cadenaFecha;
                    a.click();
                }
                request.send();
            } catch (ex) {
        ...
        function BuildParamsToGetOutbound(page, itemsPerPage, dtStart, dtEnd) {
            var dt1 = GeneralInfo.formatDate(dtStart);
            var dt2 = GeneralInfo.formatDate(dtEnd);

            //self.model = new OutboundDtoGet(); _ChangueItemsPerPage
