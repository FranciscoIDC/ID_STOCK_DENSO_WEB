(function () {
    angular
        .module('app')
        .controller('RampAddController', RampAddController);

    RampAddController.$inject = [
        '$scope',
        'RampAddService',
        'AlertService',
        'RampService',
    ...
    function RampAddController(self, RampAddService, AlertService, RampService, ErrorService, RoleListService, GeneralInfo) {
        ...
        function _InitValues() {
            ...
            self.validations = RampService.validations;
        }
        ...
        async function _SaveAsync() {
            try {
                ...
                let response = await RampAddService.Save(self.model);
                swal.close();
