(function () {
    angular
        .module('app')
        .controller('RampEditController', RampEditController);

    RampEditController.$inject = [
        '$scope',
        '$stateParams',
        'RampEditService',
        'AlertService',
    ...
    function RampEditController(self, $stateParams, RampEditService, AlertService, ErrorService, ConstService, GeneralInfo, RoleListService) {
        ...
        async function _UpdateAsync() {
            try {
                ...
                let response = await RampEditService.Update(self.model);
        ...
        async function _GetRampById() {
            try {
                let response = await RampEditService.Get(self.rampId);
                const { Status: status, Message: message, Data: data, Counter: counter } = response.data;
                console.log("_GetRampById: ", response);
