(function () {
    angular
        .module('app')
        .controller('RejectionAddController', RejectionAddController);

    RejectionAddController.$inject = [
        '$scope',
        'RejectionAddService',
        'AlertService',
        'RejectionService',
    ...
    function RejectionAddController(self, RejectionAddService, AlertService, RejectionService, ErrorService, RoleListService, GeneralInfo) {
        ...
        function _InitValues() {
            ...
            self.validations = RejectionService.validations;
        }
        ...
        async function _SaveAsync() {
            try {
                ...
                let response = await RejectionAddService.Save(self.model);
                swal.close();
        ...
        function _ClearForm() {
            self.model = new RejectionDtoPost();
        }
