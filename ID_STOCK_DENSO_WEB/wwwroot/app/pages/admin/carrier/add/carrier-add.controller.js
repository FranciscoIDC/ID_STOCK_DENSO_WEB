(function () {
    angular
        .module('app')
        .controller('CarrierAddController', CarrierAddController);

    CarrierAddController.$inject = [
        '$scope',
        'CarrierAddService',
        'AlertService',
        'CarrierService',
    ...
    function CarrierAddController(self, CarrierAddService, AlertService, CarrierService, ErrorService, RoleListService, GeneralInfo) {
        ...
        function _InitValues() {
            ...
            self.validations = CarrierService.validations;
        }
        ...
        async function _SaveAsync() {
            try {
                ...
                let response = await CarrierAddService.Save(self.model);
                swal.close();
