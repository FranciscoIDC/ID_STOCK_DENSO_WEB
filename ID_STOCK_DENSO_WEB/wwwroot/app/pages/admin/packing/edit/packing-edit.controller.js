(function () {
    ...
    function PackingEditController(self, $stateParams, PackingEditService, AlertService, ErrorService, ConstService, GeneralInfo, RoleListService) {


        async function _Init() {
            _InitValues();
            _RegisterFunctions();
            await _GetPackingById();
        }

        function _InitValues() {

            self.editMode = false;
            self.packingId = $stateParams.id;
        ...
        async function _UpdateAsync() {
            try {
                ...
                let response = await PackingEditService.Update(self.model);
        ...
        async function _GetPackingById() {
            try {
                let response = await PackingEditService.Get(self.packingId);
                const { Status: status, Message: message, Data: data, Counter: counter } = response.data;
                console.log("_GetPackingById: ", response);
