(function () {
    angular
        .module('app')
        .controller('PackingAddController', PackingAddController);

    PackingAddController.$inject = [
        '$scope',
        'PackingAddService',
        'AlertService',
        'PackingService',
    ...
    function PackingAddController(self, PackingAddService, AlertService, PackingService, ErrorService, RoleListService, GeneralInfo) {
        ...
        function _InitValues() {
            ...
            self.validations = PackingService.validations;
        }
        ...
        async function _SaveAsync() {
            try {
                ...
                let response = await PackingAddService.Save(self.model);
                swal.close();
