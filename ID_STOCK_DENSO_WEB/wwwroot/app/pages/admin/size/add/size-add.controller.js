(function () {
    angular
        .module('app')
        .controller('SizeAddController', SizeAddController);

    SizeAddController.$inject = [
        '$scope',
        'SizeAddService',
        'AlertService',
        'SizeService',
    ...
    function SizeAddController(self, SizeAddService, AlertService, SizeService, ErrorService, RoleListService, GeneralInfo) {
        ...
        function _InitValues() {
            ...
            self.validations = SizeService.validations;
        }
        ...
        async function _SaveAsync() {
            try {
                ...
                let response = await SizeAddService.Save(self.model);
                swal.close();
