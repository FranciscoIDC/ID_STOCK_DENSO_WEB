(function () {
    angular
        .module('app')
        .controller('FieldLogAddController', FieldLogAddController);

    FieldLogAddController.$inject = [
        '$scope',
        'FieldLogAddService',
        'AlertService',
        'FieldLogService',
    ...
    function FieldLogAddController(self, FieldLogAddService, AlertService, FieldLogService, ErrorService, RoleListService, GeneralInfo) {
        ...
        function _InitValues() {
            self.model = new FieldLogDtoPost();

            self.categories = [];
            self.locations = [];

            self.validations = FieldLogService.validations;
        }
        ...
        async function _SaveAsync() {
            try {
                ...
                let response = await FieldLogAddService.Save(self.model);
                swal.close();
