(function () {
    angular
        .module('app')
        .controller('VarietyAddController', VarietyAddController);

    VarietyAddController.$inject = [
        '$scope',
        'VarietyAddService',
        'AlertService',
        'VarietyService',
    ...
    function VarietyAddController(self, VarietyAddService, AlertService, VarietyService, ErrorService, RoleListService, GeneralInfo) {
        ...
        function _InitValues() {
            ...
            self.validations = VarietyService.validations;
        }
        ...
        async function _SaveAsync() {
            try {
                ...
                let response = await VarietyAddService.Save(self.model);
                swal.close();
