(function () {
    angular
        .module('app')
        .controller('FarmerAddController', FarmerAddController);

    FarmerAddController.$inject = [
        '$scope',
        'FarmerAddService',
        'AlertService',
        'FarmerService',
    ...
    function FarmerAddController(self, FarmerAddService, AlertService, FarmerService, ErrorService, RoleListService, GeneralInfo) {
        ...
        function _InitValues() {
            ...
            self.validations = FarmerService.validations;
        }
        ...
        async function _SaveAsync() {
            try {
                ...
                let response = await FarmerAddService.Save(self.model);
                swal.close();
