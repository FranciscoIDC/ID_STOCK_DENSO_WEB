(function () {
    angular
        .module('app')
        .controller('BoxAddController', BoxAddController);

    BoxAddController.$inject = [
        '$scope',
        'BoxAddService',
        'AlertService',
        'BoxService',
    ...
    function BoxAddController(self, BoxAddService, AlertService, BoxService, ErrorService, RoleListService, GeneralInfo) {
        ...
        function _InitValues() {
            ...
            self.validations = BoxService.validations;
        }
        ...
        async function _SaveAsync() {
            try {
                ...
                let response = await BoxAddService.Save(self.model);
                swal.close();
